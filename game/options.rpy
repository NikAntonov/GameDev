...
define config.save_directory = "GameDev-1516574180"
...
init python:
    ...
    ## задающей директорию. Если обнаруживается множество одноимённых файлов, то
